package tw.edu.pu.csim.s1120053.gesture
...
import tw.edu.pu.csim.s1120053.gesture.ui.theme.GestureTheme
...
@Composable
fun PointerEvents() {
    var msg by remember { mutableStateOf("作者：張惠芯") }
    Column {
        Text("\n" + msg)
        Box(
            Modifier
...
fun Drag_Horizontal() {
    ...
    Text(
        text = "水平拖曳",
        modifier = Modifier
            .offset { IntOffset(offsetX.toInt(), 150) }
            .draggable(
